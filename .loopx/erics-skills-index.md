...
## benchmark
*Kind:* `ability`  *Dir:* `skills/erics-ability/benchmark/SKILL.md`
...
## benchmark-models
*Kind:* `ability`  *Dir:* `skills/erics-ability/benchmark-models/SKILL.md`
...
## context-restore
*Kind:* `ability`  *Dir:* `skills/erics-ability/context-restore/SKILL.md`
...
## context-save
*Kind:* `ability`  *Dir:* `skills/erics-ability/context-save/SKILL.md`
...
## design-consultation
*Kind:* `ability`  *Dir:* `skills/erics-ability/design-consultation/SKILL.md`
...
## devex-review
*Kind:* `ability`  *Dir:* `skills/erics-ability/devex-review/SKILL.md`
...
## erics-ability-cso
*Kind:* `ability`  *Dir:* `skills/erics-ability/erics-ability-cso/SKILL.md`
...
*Kind:* `ability`  *Dir:* `skills/erics-ability/erics-ability-plan-ceo-review/SKILL.md`
...
*Kind:* `ability`  *Dir:* `skills/erics-ability/erics-ability-plan-eng-review/SKILL.md`
...
## health
*Kind:* `ability`  *Dir:* `skills/erics-ability/health/SKILL.md`
...
## office-hours
*Kind:* `ability`  *Dir:* `skills/erics-ability/office-hours/SKILL.md`
...
## retro
*Kind:* `ability`  *Dir:* `skills/erics-ability/retro/SKILL.md`
...
## spec
*Kind:* `ability`  *Dir:* `skills/erics-ability/spec/SKILL.md`
...
*Kind:* `process`  *Dir:* `skills/erics-process/erics-process-archive-agent-notes/SKILL.md`
...
*Kind:* `process`  *Dir:* `skills/erics-process/erics-process-code-review/SKILL.md`
...
*Kind:* `process`  *Dir:* `skills/erics-process/erics-process-doc-site-sync/SKILL.md`
...
*Kind:* `process`  *Dir:* `skills/erics-process/erics-process-doc-standards/SKILL.md`
...
*Kind:* `process`  *Dir:* `skills/erics-process/erics-process-find-simplifications/SKILL.md`
...
*Kind:* `process`  *Dir:* `skills/erics-process/erics-process-merging-stacked-prs/SKILL.md`
...
*Kind:* `process`  *Dir:* `skills/erics-process/erics-process-pre-push-checks/SKILL.md`
...
*Kind:* `process`  *Dir:* `skills/erics-process/erics-process-prose-standard/SKILL.md`
...
*Kind:* `process`  *Dir:* `skills/erics-process/erics-process-record-browser-gif/SKILL.md`
...
*Kind:* `process`  *Dir:* `skills/erics-process/erics-process-translate-docs/SKILL.md`
...
*Kind:* `process`  *Dir:* `skills/erics-process/erics-process-trim-cot-leakage/SKILL.md`
