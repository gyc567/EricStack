...
AI-native engineering loop system with 38 skills for planning, review, simplification, documentation, and knowledge accumulation.
...
/erics-loop-router      # View all 38 skills and routing rules
```
